    ...
    <section className="bg-gray-400 text-white py-16 px-6 md:px-20 relative mb-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-yellow-300 mt-8 mb-4">1. Use of Website</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-yellow-300 mt-8 mb-4">2. Intellectual Property</h2>
          <p>
            This website contains material which is owned by or licensed to us. This material includes, but is not limited to, the design, layout, look, appearance and graphics. Reproduction is prohibited other than in accordance with the copyright notice, which forms part of these terms and conditions.
          </p>

          <h2 className="text-2xl font-bold text-yellow-300 mt-8 mb-4">3. Links to Other Websites</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-yellow-300 mt-8 mb-4">4. Disclaimer</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-yellow-300 mt-8 mb-4">5. Governing Law</h2>
          <p>
