...
const AboutUs = () => {
  return (
    <section className="bg-gray-400 text-white py-16 px-6 md:px-20 relative z-40 mb-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          About <span className="text-yellow-300">Senzo</span>
        </motion.h2>
        ...
        >
          ...
          <p>
            With over <span className="text-yellow-300 font-semibold">10+ manufacturing plants</span> 
            and <span className="text-yellow-300 font-semibold">300+ trained experts</span>, 
        ...
        >
          <div className="bg-gray-500 p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
            <h3 className="text-xl font-bold text-yellow-300 mb-3">Our Vision</h3>
            <p>
          ...
          <div className="bg-gray-500 p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
            <h3 className="text-xl font-bold text-yellow-300 mb-3">Our Mission</h3>
            <p>
          ...
          <div className="bg-gray-500 p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
            <h3 className="text-xl font-bold text-yellow-300 mb-3">Our Values</h3>
            <p>
