      ...
      <Router>
        ...
        <main className="pt-24">  
          <Routes>
            ...
            <Route path="/tools/adhesive-coverage" element={<AdhesiveCoverage />} />
            <Route path="/tools/joint-filler-coverage" element={<JointFillersCoverage />} />
            <Route path="/tools/tile-adhesive-recommender" element={<AdhesiveRecommender />} />
            <Route path="/tools/tile-joint-filler-visualizer" element={<JointFillersVisuals />} />

            <Route path="/products/:slug" element={<ProductDetail />} />
            <Route path="/category/tile-adhesive" element={<TileAdhesive />} />
          <Route path="/category/epoxy-grout" element={<EpoxyGrout />} />
          <Route path="/category/other-products" element={<OtherProducts />} />
